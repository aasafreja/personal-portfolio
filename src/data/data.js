...
import JobMatch from "../img/dashboard.png";
...
export const experiences = [
  {
    ...
    type: "Contract",
    description: [
      "Designed and implemented backend architecture using MERN stack — MongoDB data modeling, enrollment logic, role-based access control",
      "Built React component architecture for athlete dashboard including protected routes, progress tracking UI, and video content management with cloud storage",
      "Integrated Stripe for course purchases and subscription management, Clerk for authentication on both frontend and backend",
      "Built and deployed responsive landing page — live in production",
    ],
    skills: [
      "React",
      "Node.js",
...
export const projects = [
  {
    title: "JobMatch - AI Job Search Assistant",
    description:
      "Full-stack AI-powered job search app that scrapes LinkedIn via Apify, matches jobs to your CV using OpenAI embeddings and pgvector cosine similarity, and provides AI-generated gap analysis, interview questions, and a Kanban job tracker.",
    tags: [
      "Next.js 14",
      "TypeScript",
      "Supabase (pgvector)",
    ...
    github: "https://github.com/aasafreja/jobmatch",
    demo: "https://...",
    image: JobMatch,
  },
  {
    ...
    description:
      "JWT-authenticated notes app with CRUD functionality and cloud image storage, and comprehensive Playwright E2E tests.",
    tags: [
      "React",
      "Node.js",
      "PostgreSQL (Neon)",
...

  {
    ...
    description:
      "Commercial landing page for a home-based bakery with a custom cake order system, interactive builder, and reliable serverless form notifications.",
    tags: [
      "React",
      "Vite",
      "Tailwind CSS",
  ...
  },
  {
    ...
    description:
      "Landing page for SPĒXS, showcasing management consulting services for fitness businesses. Focused on designing a clean, responsive, and user-friendly UI.",
